...
*/
export function setupRouterRoutes(router: Router, routes?: Routes) {
    // routes can be:
    // - a function
    ...
    return throwInvalidArgument(
        '@eviljs/std-node-rest/routing.setupRouterRoutes(router, ~~routes~~):\n'
...
export type Routes = undefined | null | Middleware | Route | Array<Middleware | Route | Routes>

export interface Route {
    method?: RouteMethodExt | Array<RouteMethodExt>
    path: string | RegExp
